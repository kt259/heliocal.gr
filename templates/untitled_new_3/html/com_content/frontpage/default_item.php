...
if ($article->showCreateDate)
    $params['metadata-header-icons'][] = JHTML::_('image.site', 'postdateicon.png', null, null, null, JText::_("postdateicon"), array('width' => '15', 'height' => '14')) . $article->createDateInfo();
if ($article->showModifyDate)
    $params['metadata-header-icons'][] = JHTML::_('image.site', 'postdateicon.png', null, null, null, JText::_("postdateicon"), array('width' => '15', 'height' => '14')) . $article->modifyDateInfo();
if ($article->showPublishDate)
    $params['metadata-header-icons'][] = JHTML::_('image.site', 'postdateicon.png', null, null, null, JText::_("postdateicon"), array('width' => '15', 'height' => '14')) . $article->publishDateInfo();
if ($article->showAuthor)
    $params['metadata-header-icons'][] = JHTML::_('image.site', 'postauthoricon.png', null, null, null, JText::_("postauthoricon"), array('width' => '18', 'height' => '18')) . $article->authorInfo();
